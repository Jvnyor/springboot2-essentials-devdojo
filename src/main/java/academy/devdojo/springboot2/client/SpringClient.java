...
//        log.info("saved anime {}", kingdomSaved);
        ...
        ResponseEntity<Void> samuraiChamplooUpdated = new RestTemplate().exchange("http://localhost:8080/animes/replace",
                HttpMethod.PUT,
        ...
        ResponseEntity<Void> samuraiChamplooDeleted = new RestTemplate().exchange("http://localhost:8080/animes/delete/{id}",
                HttpMethod.DELETE,
                null,
                Void.class,
